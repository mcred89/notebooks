...
# Score on the training set was:0.9933159527149715
exported_pipeline = make_pipeline(
    RFE(estimator=ExtraTreesClassifier(criterion="entropy", max_features=0.55, n_estimators=100), step=0.15000000000000002),
    StackingEstimator(estimator=GradientBoostingClassifier(learning_rate=1.0, max_depth=1, max_features=0.8500000000000001, min_samples_leaf=6, min_samples_split=19, n_estimators=100, subsample=1.0)),
